...
import 'package:flutterbasic/function/future_function.dart';
...
class HomeScreen extends StatelessWidget {
  const HomeScreen({super.key, required bool isDarkMode, required void Function(bool isDark) onThemeToggle});
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 20,),
                ElevatedButton(onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => TabExample(),));
                ...
                SizedBox(height: 20,),
                ElevatedButton(onPressed: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) => BasicPractice(),));
